...
This project makes it easy for Red Hat employees to use an existing [Red Hat Demo Platform](https://demo.redhat.com) (RHDP) environment to demonstrate key Red Hat Satellite capabilities.

## Pre-requisites

1. This project is intended for use by Red Hat employees with access to RHDP, and depends on a RHDP-deployed environment to run.
